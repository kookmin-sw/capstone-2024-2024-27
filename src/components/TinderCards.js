...
//   useEffect(() => {}, []);
  ...
  return (
    <div className="tinderCards__cardContainer">
        <h1>Tinder Cards</h1>
        {/* <img src={`${people.url}`} /> */}
        <img src='https://upload.wikimedia.org/wikipedia/commons/thumb/d/dc/Steve_Jobs_Headshot_2010-CROP_%28cropped_2%29.jpg/1280px-Steve_Jobs_Headshot_2010-CROP_%28cropped_2%29.jpg' className='card'/>
